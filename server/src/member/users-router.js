...
router.post("/addmember", async (req, res, next) => {
  ...
  const memberMail = req.body.memberMail;
  const memberPwd = req.body.memberPwd;
  const addMemberSql = `INSERT INTO member(memberName, memberGender, memberBirth, memberPhone, 	memberAddress	,	memberMail,	memberPwd,	memberImg, memberStatus) VALUES('迷失的文青','男','2020-01-01','請輸入連絡電話','請輸入地址',?,?,'tmp.jpg','true')`;
